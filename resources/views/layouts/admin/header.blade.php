...
@if(Auth::user()->profile_image && file_exists(public_path('storage/'.Auth::user()->profile_image)))
    <div class="w-8 h-8 rounded-full overflow-hidden shadow-sm bg-gray-100">
        <img
...
@endif
            ...
            >
               ...
               <a href="{{ route('admin.profile') }}"
                ...
                <a href="{{ admin_route('warehouses.index') }}" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
