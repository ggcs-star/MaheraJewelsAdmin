...
<div class="space-y-4">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-3">
        <div>
            <div class="flex items-center gap-2 text-sm text-gray-500 mb-1">
                ...
                <span class="text-gray-600">Edit Customer</span>
            </div>
            <h1 class="text-2xl font-bold text-gray-800">Edit Customer</h1>
            <p class="text-sm text-gray-500 mt-0.5">Update customer information</p>
        </div>
    ...
    <form method="POST" action="{{ admin_route('customers.update', $customer) }}" novalidate>
        @csrf
        @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address_line_2"
                                  rows="2"
                                  class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-[#8B2452] focus:ring-2 focus:ring-[#8B2452]/20 transition-all text-sm @error('address_line_2') border-red-500 @enderror">{{ old('address_line_2', $customer->address_line_2) }}</textarea>
