...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow border">
        ...
        <form action="{{ route('admin.notification-settings.update',$notificationSetting) }}"
              method="POST">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input
                        type="email"
                        name="email"
                        value="{{ old('email',$notificationSetting->email) }}"
                        required
                        class="w-full border rounded-lg px-4 py-2">
                ...
                <div>
                    ...
                    <label class="inline-flex items-center gap-2">
                        ...
                        <input
                            type="checkbox"
                            name="receive_order"
                            {{ $notificationSetting->receive_order ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <label class="inline-flex items-center gap-2">
                        ...
                        <input
                            type="checkbox"
                            name="receive_cancel"
                            {{ $notificationSetting->receive_cancel ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <label class="inline-flex items-center gap-2">
                        ...
                        <input
                            ...
                            {{ $notificationSetting->receive_registration ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <label class="inline-flex items-center gap-2">
                        ...
                        <input
                            ...
                            {{ $notificationSetting->receive_contact ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <label class="inline-flex items-center gap-2">
                        ...
                        <input
                            type="checkbox"
                            name="is_active"
                            {{ $notificationSetting->is_active ? 'checked' : '' }}>
