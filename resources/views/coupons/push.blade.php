...
<style>
    ...
    /* Coupon Header - Light Maroon Gradient */
    .coupon-header {
    ...
    /* ✅ Hidden checkbox - accessible and submittable */
    ...
    <div class="coupon-header">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
            <div>
                ...
                <p>
                    <i class="fas fa-pen-fancy me-1"></i>Configure your coupon offer with detailed settings
                </p>
            </div>
            <div>
                <span class="badge-gold">
                    <i class="fas fa-plus-circle me-1"></i> New Coupon
                </span>
            </div>
        </div>
    </div>
...
<form method="POST" action="{{ route('admin.coupons.store') }}">
    ...
    <div class="section-wrapper mb-3">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <select name="generate_type" id="generate_type" class="form-select @error('generate_type') is-invalid @enderror">
                    <option value="single" {{ old('generate_type', 'single') == 'single' ? 'selected' : '' }}>Single Coupon</option>
                    <option value="bulk" {{ old('generate_type') == 'bulk' ? 'selected' : '' }}>Bulk Coupon</option>
                </select>
                @error('generate_type')
    ...
    <div class="section-wrapper mb-3">
        ...
        <div class="row g-3">
            @foreach($platforms->take(3) as $platform)
                ...
                <div class="col-md-4">
    <label class="d-block m-0 cursor-pointer" style="display: block; width: 100%;">
        <input type="checkbox"
               name="platform_ids[]"
               value="{{ $platform->id }}"
               style="position: absolute; opacity: 0; width: 0; height: 0; pointer-events: none;"
               {{ in_array($platform->id, old('platform_ids', [])) ? 'checked' : '' }}>                            
        <div class="platform-card {{ in_array($platform->id, old('platform_ids', [])) ? 'selected' : '' }}">
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="flex-grow-1">
                    <h6>{{ $platform->name }}</h6>
                    <span class="badge-theme">{{ in_array($platform->id, old('platform_ids', [])) ? 'Selected' : 'Select' }}</span>
                </div>
                
                <div class="check-icon {{ in_array($platform->id, old('platform_ids', [])) ? '' : 'd-none' }}">
    ...
    <div class="section-wrapper mb-3">
        ...
        <div class="row g-4">
            ...
            <div id="bulk_fields" style="display: none;" class="col-12">
                <div class="row g-4">
                    <div class="col-md-4">
                        <label class="form-label">
            ...
            <div class="col-12">
                ...
                <textarea
                    ...
                    class="form-control"
                    rows="2"
                    placeholder="Enter coupon description...">{{ old('coupon_description') }}</textarea>
                <div class="form-text">
    ...
    <!-- ===== BANK OFFER ===== -->
    <div class="bank-field d-none section-wrapper mb-3">
        <div class="d-flex align-items-center gap-2 mb-2">
            <div class="icon">
